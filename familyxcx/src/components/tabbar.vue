      ...
      navList: [
        {
          ...
          iconPath:
            'http://test.admin.school.mseenet.com/html/img/iOS切图/tab/tab_school_nor@3x.png',
          selectedIconPath:
            'http://test.admin.school.mseenet.com/html/img/iOS切图/tab/tab_school_sel@3x.png',
          text: '校园'
        },
        {
...

        {
          ...
          iconPath:
            'http://test.admin.school.mseenet.com/html/img/iOS切图/tab/tab_me_nor@3x.png',
          selectedIconPath:
            'http://test.admin.school.mseenet.com/html/img/iOS切图/tab/tab_me_sel@3x.png',
          text: '我的'
        }
      ],
      navListOne: [
...

        {
          ...
          iconPath:
            'http://test.admin.school.mseenet.com/html/img/iOS切图/tab/tab_issue_nor@2x.png',
          selectedIconPath:
            'http://test.admin.school.mseenet.com/html/img/iOS切图/tab/tab_issue_nor@2x.png',
          text: '发布',
          active: true
